...
const DEFAULT_STATE = {
  ...
  bottomRaw: '',
  bottomLines: [],
  topSettings: { useBackground: true, bgColor: '#000000', useMask: false, textOutside: false },
  bottomSettings: { useBackground: true, bgColor: '#000000', useMask: false, textOutside: false },
  filterNotices: true,
  filterRadio: true,
